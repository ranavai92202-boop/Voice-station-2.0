...
`;
 ...
 return request("https://i.imgur.com/Akgp5G8.jpeg").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
 }
 ...
 return request("https://i.imgur.com/BXkzdeI.jpeg").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
};
