...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "𝐅𝐚𝐫𝐡𝐚𝐝") || (event.body.toLowerCase() == "Farhad bai") || (event.body.toLowerCase() == "@RA NA") || (event.body.toLowerCase() == "রানা")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐑𝐀𝐍𝐀☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐑𝐀𝐍𝐀.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/1DJBHwCvTp/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +971581156686", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝐑𝐀𝐍𝐀❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রানা আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐑𝐀𝐍𝐀❤️ তাকে সবাই রানা নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@ Farhad Uddin") || (event.body.toLowerCase() == "ফরহাদ")) {
     return api.sendMessage("🥰-ফরহাদ-🌺 আমার বস রানা'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
